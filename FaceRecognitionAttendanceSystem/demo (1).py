        ...
        def draw_boundary(img, classifier, scaleFactor, minNeighbors, color, text, clf):
            ...
            for (x, y, w, h) in features:
                ...
                if confidence > 77:
                    ...
                    self.counter += 1
                    if self.counter == 1:
                        with open("djskr.rtc","w")as file:
                            file.write(str(recognised_student_roll)+":"+str(recognised_student_name)+":"+str(recognised_student_dep))
...
class PageTwo(tk.Frame):
    def __init__(self, parent, controller):
        ...
        name=""
        dept=""
        if os.path.exists("djskr.rtc"):
            with open("djskr.rtc", "r")as file:
                try:roll,name,dept=str(file.read()).split(":")
                except:print("Content not fetched")
        print("page2",roll,name,dept)
