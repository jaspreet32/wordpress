...
if ( ! class_exists( 'Township_Lite_Theme_Info' ) ) :

	/**
	 * Township_Lite_Theme_Info class.
	 */
	class Township_Lite_Theme_Info extends WP_Customize_Control {
		...
		/**
		 * Township_Lite_Theme_Info constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'Township_Lite_Theme_Info' );
		...
		public function enqueue() {
			wp_enqueue_style( 'township-lite-style', esc_url(get_template_directory_uri()) . '/inc/css/township-style.css', '1.0.0' );
		}
