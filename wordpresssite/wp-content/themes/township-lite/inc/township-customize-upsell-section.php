 ...
 */
/**
 * Class Township_Lite_Customizer_Upsell_Section
 */
class Township_Lite_Customizer_Upsell_Section extends WP_Customize_Section {
	/**
	...
	/**
	 * Township_Lite_Customizer_Upsell_Section constructor.
	 */
	public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
		$manager->register_section_type( 'Township_Lite_Customizer_Upsell_Section' );
